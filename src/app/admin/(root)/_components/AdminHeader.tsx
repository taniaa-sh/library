    ...
    return (
        <>
            ...
            <div className="w-full flex flex-col gap-4 fixed bg-white dark:bg-[#0d1b3b] p-6 !shadow-md z-50 transition-all">
                ...
                <input
                    className="md:hidden block p-2 rounded-lg placeholder-gray-400 dark:placeholder-gray-500 border border-gray-300 dark:border-gray-600 bg-white dark:bg-dark-400 text-black dark:text-whitew-full md:w-[280px] lg:w-[300px] transition-all"
                    type="text"
                    placeholder="Search..."
                />
            </div>
