...
const DragAndDropUpload = ({ onChange, type = 'image', preview }: DragAndDropUploadProps) => {
    ...
    return (
        <>
            <div
                className={`w-full h-36 border-2 border-dashed rounded-xl flex flex-col items-center justify-center cursor-pointer transition-all ${isDragging ? 'border-blue-500 bg-blue-50' : `border-gray-300 ${isAdminPath ? 'hover:border-blue-400' : 'hover:border-[#ddbfa3] dark:hover:border-[#7a6233]'}`
