...
const Footer = () => {
    return (
        <footer className="bg-gradient-to-b from-gold100 to-gold200 dark:from-gold400 dark:to-gold500 text-black dark:text-white px-6 py-12 mt-16 rounded-t-4xl">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-8">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <div className="flex flex-col md:flex-row md:gap-4">
                        <Link
                            href={SiteUrls.dashbord}
                            className="hover:!text-gold400 dark:hover:!text-gold800 group relative transition-colors duration-200"
                        >
                            Dashboard
                        ...
                        <Link
                            ...
                            className="hover:!text-gold800 dark:hover:!text-gold400 group relative transition-colors duration-200"
                        >
                            books
